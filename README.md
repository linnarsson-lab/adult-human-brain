...
The files with the molecule coordinates (as .parquet) and gene x cell counts (as .loom) are available at: https://console.cloud.google.com/storage/browser/linnarsson-lab-human/EEL_adult
