...
class Level2Adolescent(luigi.WrapperTask):
	...
	def requires(self) -> Iterator[luigi.Task]:
		...
		for tissue in tissues:
			...
			yield cg.PlotClassesL2(project="Adolescent", tissue=tissue, major_class="Neurons")
			yield cg.PlotMarkerheatmapL2(project="Adolescent", tissue=tissue, major_class="Neurons")

		# for tissue in tissues:
		# 	yield cg.PlotCVMeanL2(project="Adolescent", tissue=tissue, major_class="Excluded")
		# 	yield cg.PlotGraphL2(project="Adolescent", tissue=tissue, major_class="Excluded")
		# 	yield cg.MarkerEnrichmentL2(project="Adolescent", tissue=tissue, major_class="Excluded")
		# 	yield cg.PlotClassesL2(project="Adolescent", tissue=tissue, major_class="Excluded")
		...
		for cls in classes:
			...
			yield cg.PlotClassesL2(project="Adolescent", tissue="All", major_class=cls)
			yield cg.PlotMarkerheatmapL2(project="Adolescent", tissue="All", major_class=cls)
