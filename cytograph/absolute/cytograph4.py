...
class Cytograph4:
	def __init__(self, n_genes: int = 1000, n_factors: int = 96, k_smoothing: int = 100) -> None:
	...
	def fit(self, ds: loompy.LoomConnection) -> None:
		...
		hpf = cg.HPF(k=self.n_factors, min_iter=10, max_iter=100, validation_fraction=0.02, max_r=0.9)
		hpf.fit(data)
